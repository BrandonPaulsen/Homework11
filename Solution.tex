...
\begin{solution}
    ...
    \begin{itemize}
        ...
        \item $S$ be the subset sum problem
    ...
    In subset sum, we are given some set of elements $E = \{e_1, e_2, \dots, e_n\}$ and some target value $W$ and must select some subset $F \subseteq E$ such that $\sum_{e \in F} e = W$.
    ...
    What happens if we select $A$ with the minimal sum satisfying this relation:
        ...
        $$\Rightarrow \sum_{p \in P} p = 2 \sum_{e \in E} e + 1$$
    ...
    What if it was just a little larger?
        ...
        $$\Rightarrow \sum_{p \in P} p = 2 \sum_{e \in E} e + 2$$
    ...
    $$\Rightarrow \sum_{p \in P} = 2 \sum_{2 \in P_1} = 2a_1 + W$$
\end{solution}
